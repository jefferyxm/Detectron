...
class DetectionModelHelper(cnn.CNNModelHelper):
    ...
    def GenerateProposals(self, blobs_in, blobs_out, anchors, spatial_scale, ap_size):
        ...
        self.net.Python(
            GenerateProposalsOp(anchors, spatial_scale, self.train, ap_size).forward
    ...
    def RoIFeatureTransform(
        ...
        if isinstance(blobs_in, list):
            ...
            for lvl in range(k_min, k_max + 1):
                ...
                # adaptive feature pooling, need get all feature from all fpn level
                if cfg.TRAIN.AFP:
                    bl_rois = blob_rois
                else:
