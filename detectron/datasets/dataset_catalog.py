...
_DATASETS = {
    ...
    'icdar_2015_train': {
        _IM_DIR:
            _DATA_DIR + '/icdar/icdar15/train',
        _ANN_FN:
            _DATA_DIR + '/icdar/icdar15/annotations/anno_train_icdar15.json'
    },
    'icdar_2015_val': {
        _IM_DIR:
    ...
    'icdar_2017_train': {
        _IM_DIR:
            _DATA_DIR + '/icdar/icdar17/train',
        _ANN_FN:
            _DATA_DIR + '/icdar/icdar17/annotations/anno_train_icdar17.json'
    },
    'icdar_2017_val': {
        _IM_DIR:
            _DATA_DIR + '/icdar/icdar17/test',
        _ANN_FN:
            _DATA_DIR + '/icdar/icdar17/annotations/anno_test_icdar17.json'
    },
    'med_train': {
        _IM_DIR:
            _DATA_DIR + '/med/train',
    ...
    'med_test': {
        _IM_DIR:
            _DATA_DIR + '/med/test',
        _ANN_FN:
            _DATA_DIR + '/med/annotations/anno_test_med.json'
    }
}
